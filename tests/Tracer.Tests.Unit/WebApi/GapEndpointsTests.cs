...
public sealed class GapEndpointsTests : IAsyncDisposable
{
    ...
    [Fact]
    public async Task Gaps_LiveMode_Returns409()
    {
        _webFixture = await WebApiFixture.CreateAsync();
        var resp = await _webFixture.Client.GetAsync(
            "/api/gaps?from=2026-01-01T00:00:00Z&to=2026-01-01T01:00:00Z");
        resp.StatusCode.Should().Be(HttpStatusCode.Conflict);
    }

    [Fact]
    public async Task Gaps_BundleMode_Returns200()
    {
