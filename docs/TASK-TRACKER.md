...
- [ ] **TRC-P2-001** New Core Abstractions [details](./TASK-DETAIL.md#trc-p2-001--new-core-abstractions-in-tracercore)
- [ ] **TRC-P2-002** Fast-State Parquet Writers [details](./TASK-DETAIL.md#trc-p2-002--fast-state-parquet-writers)
- [ ] **TRC-P2-003** Agent Configuration & DI [details](./TASK-DETAIL.md#trc-p2-003--agent-configuration--di)
- [ ] **TRC-P2-004** Ingestion Pipeline [details](./TASK-DETAIL.md#trc-p2-004--ingestion-pipeline)
- [ ] **TRC-P2-005** Interval Rotation Lifecycle [details](./TASK-DETAIL.md#trc-p2-005--interval-rotation-lifecycle)
- [ ] **TRC-P2-006** Startup Recovery [details](./TASK-DETAIL.md#trc-p2-006--startup-recovery)
- [ ] **TRC-P2-007** Upload & Retention [details](./TASK-DETAIL.md#trc-p2-007--upload--retention)
- [ ] **TRC-P2-008** Mock Transport & Upload [details](./TASK-DETAIL.md#trc-p2-008--mock-transport--upload)
- [ ] **TRC-P2-009** FakeNode [details](./TASK-DETAIL.md#trc-p2-009--fakenode)
